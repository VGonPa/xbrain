...
overwritten by then. Before re-digesting items that currently have frames, copy
those directories aside and restore them with the snapshot if needed. Without
