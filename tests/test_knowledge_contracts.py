...
its title, `EvidenceBundle` "2" since U-1, the graph envelope "1"), while the services
that fill them do not exist yet. That is the point: spec §7.1 says CLI JSON and MCP are adapters over the same
