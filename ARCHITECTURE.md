...
22,286** real ones (27.2 %), re-derived 2026-09-01 on the then-shipped chunker (v2, `800/0`,
`store-2404`, which [no copy kept](docs/knowledge-index.md#measured-versions)). **`CHUNKER_VERSION` is `v3` since Plan 02.9**, and this count still stands:
...
chunker v1 and `store-2404`, quoted by md5 — correct for that population, and left undated after
